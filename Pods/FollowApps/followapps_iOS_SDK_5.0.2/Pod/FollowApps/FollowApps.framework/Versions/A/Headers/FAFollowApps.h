...
@property(nonatomic, strong) id <FAFollowAppsDelegate> followAppsDelegate;
...
- (BOOL)application:(UIApplication *)app openURL:(NSURL *)url options:(NSDictionary<id,id> * _Nullable)options;
